Korst Station is a border monitoring post on [[Auralis]]'s northeastern desert edge, fifty miles north of [[Emberfall]]. Population under 80. It specializes in rift-activity tracking, route-condition assessment, and providing real-time intelligence that determines whether crossings should proceed or abort.
...
**Rift activity intensity** — detecting surges in [[Flux]] demon emergence, tracking spatial patterns of rift behavior, and assessing whether current activity levels make crossing routes viable or prohibitively dangerous.

**Environmental stress cycles** — measuring temperature extremes, tracking heat-wave progression, and identifying periods when exposure risk exceeds what standard protective measures can manage.
...
When Korst Station detects conditions that make crossing dangerous, the warning propagates through the border network: to [[Halveth]]'s coordination center, to [[Seln Watch]]'s outfitters, to guide networks operating from other settlements, and directly to any active crossings that can receive the transmission.
...
But the archive's primary function is operational, not academic. Understanding rift patterns helps the station anticipate dangerous periods, recognize unusual activity that might indicate escalation, and provide travelers with probability assessments rather than simple yes/no danger signals.

When a traveler asks "Is it safe to cross today?" the answer Korst provides is "Based on eleven years of pattern data, current conditions indicate X% probability of rift encounter during a standard-duration crossing, with surge intensity likely to range between Y and Z." That level of detail allows travelers to make informed risk assessments rather than proceeding on assumptions.

## The Population

Living at Korst Station means accepting isolation, limited social infrastructure, and work that consists primarily of watching for patterns in data streams that sometimes indicate people are about to die.
...
Korst contributes the most sophisticated rift-monitoring data to the network. Other settlements contribute environmental observations, route-condition reports from returning travelers, and ground-level intelligence about conditions that sensor systems cannot detect. The combined intelligence creates a comprehensive boundary picture that no single settlement could maintain alone.

## The Economics

Korst Station operates on institutional funding from [[The Council of Auralis]] and service contracts with expedition coordinators who pay for advance intelligence before committing to crossing schedules. The funding is adequate but not generous — enough to maintain operations, not enough to expand significantly or upgrade equipment without external grant support.
...
Life at Korst Station is quiet, routine, and occasionally punctuated by moments where the work matters urgently. Monitoring shifts run continuously. Data accumulates. Patterns emerge slowly or not at all.

Social life is limited by the small population and geographic isolation. Entertainment is what residents create: shared meals, evening discussions about patterns in the data, occasional visits from border travelers who stop to verify route conditions before proceeding.

The work is not celebrated. Most people in [[Auralis]] do not know Korst Station exists. Expedition members who use the intelligence rarely credit the monitoring work that produced it. The station operates as infrastructure — essential, invisible, and only noticed when it fails.

The residents are not bothered by this. They know the work matters. They know that warnings they issue save lives even if those lives never learn who issued the warning. They are doing the work because it needs doing, not because it produces recognition.
