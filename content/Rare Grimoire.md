...
**Longbolt**
Projects a precise electrical beam from the caster toward a visible individual target up to 200 feet away.
| Variable | Value |
|---|---|
| Shape | Circle |
| Hook | Emit |
...
**Nerveshred**
Delivers a sustained neuro-disruptive field across a group within range, causing escalating pain and motor disruption while maintained.
| Variable | Value |
|---|---|
| Shape | Circle |
| Hook | Emit |
...
**Voltfield**
Sustains a crackling electrical field across a defined area, delivering continuous shock to any conductive material or individual within it.
| Variable | Value |
|---|---|
| Shape | Circle |
| Hook | Ward |
...
**Mindveil**
Wraps a sustained Mind-discipline field around a group, causing those inside to be passively overlooked by anyone outside it.
| Variable | Value |
|---|---|
| Shape | Circle |
| Hook | Ward |
...
**Soulmark**
Burns a permanent Soul-signature brand onto a willing individual, serving as a verifiable identity anchor for linked spells and oaths.
| Variable | Value |
|---|---|
| Shape | Circle |
| Hook | Bind |
...
**Soulread**
Senses the Soul signature of a touched individual, confirming identity beyond physical disguise or alteration — requires consent or restraint to apply cleanly.
| Variable | Value |
|---|---|
| Shape | Circle |
| Hook | Sense |
...
**Oathbind**
Locks a spoken agreement between two individuals at the Soul level — both parties feel the constraint, and breaking it causes measurable Flux feedback.
| Variable | Value |
|---|---|
| Shape | Circle |
| Hook | Bind |
...
**Identitymask**
Wraps a single individual in a sustained Soul-level veil that obscures their true signature, causing Soul-based detection and identification spells to return false or null results.
| Variable | Value |
|---|---|
| Shape | Circle |
| Hook | Ward |
...
**Fluxward**
Erects a sustained field that actively disrupts incoming Flux before it can resolve into a spell effect, functioning as a broad anti-magic barrier.
| Variable | Value |
|---|---|
| Shape | Circle |
| Hook | Ward |
