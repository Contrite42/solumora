...
```json
{
  "name": "Binding Amplify Beam",
  "summary": "Boosts binding constraint flux as a directed line at self reach, targeting the inscribed anchor with immediate discharge by changing existing conditions.",
