...
```json
{
  ...
  "summary": "Boosts binding constraint flux as a column volume at self reach, targeting the inscribed anchor with immediate discharge by changing existing conditions.",
