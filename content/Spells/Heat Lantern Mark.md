...
Projects a compact thermal transfer marker that remains stable long enough for routine tasks.
...
```json
{
  "name": "Heat Lantern Mark",
  "summary": "Creates a short-lived thermal transfer marker for close work.",
  "effect_description": "Projects a compact thermal transfer marker that remains stable long enough for routine tasks.",
  "hook": "Emit",
  "mode": "Create",
  "shape": "Triangle",
  "discipline": "Heat",
