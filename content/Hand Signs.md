**Hand Signs** are a discovered system of [[Flux]] casting requiring no surface, no inscription, and no prepared material. A caster channels [[Flux]] while holding a specific hand configuration and a specific effect manifests on their body. Reliably, every time, without variation.

Nobody designed this. The signs predate both [[Terravelle]] and [[Auralis]] and exist entirely outside the [[Spell Variables|Scholar variable framework]]. They cannot be extended, modified, or improved upon — they are not a system so much as a set of facts about how [[Flux]] behaves under specific physical conditions. The ceiling is [[Control Tier]] T2–T3 across all known signs. Whether higher signs exist and have not been found, or simply do not exist, is a question nobody has answered.

There are eight known signs.

They have no formal names. What follows are the names soldiers use.
...
**Control Tier:** T2 **Duration:** Sustained while the sign is held. Drops the moment the hand configuration breaks. **Practical note:** Cannot be held during actions that require both hands. Most practitioners learn to drop and reapply it rather than trying to maintain it through combat.
...
**Control Tier:** T2 **Duration:** Sustained while the sign is held. **Practical note:** Experienced practitioners report that The Step feels natural within a few seconds of activation and disorienting for a moment on release, as the body readjusts to its normal response speed. Prolonged use in extended engagements is taxing — the sign does not reduce physical fatigue, it just moves the body faster through it.
...
**Control Tier:** T2 **Duration:** Sustained while the sign is held. **Practical note:** Widely considered the most dangerous sign to use carelessly. A caster who cannot feel damage will push past injuries that would otherwise force them to stop, and discover the full extent of what they have done only when the sign is released. The [[The Voss Line|Voss]] teach it last for this reason.
...
**Control Tier:** T2 **Duration:** Sustained while the sign is held. **Practical note:** Does not identify the caster or the spell. Does not detect uncharged sigils or individuals who are not actively channeling. Useful for knowing a cast is incoming; not useful for knowing what it is.
...
**Control Tier:** T2 **Duration:** Sustained while the sign is held. **Practical note:** Does not make the caster heavier in a way that affects their own movement — they move normally. The effect is purely resistive. A [[Flux Users|Formulist]] using a Force [[Discipline]] push spell will find the sign partially but not fully effective against high-tier kinetic output.
...
**Control Tier:** T3 **Duration:** Immediate on activation. Does not need to be sustained — the effect applies once and the body continues from there. **Practical note:** The only sign that requires both hands and the only sign that sits at T3. Most practitioners who know it reached their ceiling learning it and consider it the hardest of the eight. A caster at T2 ceiling cannot activate it.
...
**Control Tier:** T2 **Duration:** Sustained while the sign is held. **Practical note:** The most situationally specific of the eight signs and the one most practitioners learn last if they learn it at all. Complete silence has narrow but decisive applications — approaching a position, passing through a sleeping camp, surviving a situation where being heard means being found.

---

All eight signs are taught by demonstration and practice only. No written record accurately captures the precise hand configuration required — descriptions exist, diagrams exist, and neither is considered reliable without a teacher who knows the sign correctly. A sign learned from a diagram alone has a meaningful failure rate.
