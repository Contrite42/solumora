The Zakros Loss Table is a comparative risk and casualty analysis office attached to [[Emberfall Expedition Registry]], responsible for converting expedition incident logs into operational policy updates for desert work.

Its mandate is narrow and unpopular: quantify how teams fail, identify failure patterns that are preventable, and produce recommendations that often slow prestigious projects in exchange for lower mortality.

## Why It Exists

For decades, expedition failures were documented as isolated stories. Teams disappeared, partial parties returned, reports were filed, and new teams departed under similar assumptions. Without cross-case analysis, recurring failure modes looked accidental rather than systematic.
...
[[Sera Nolt]], [[Control Tier|Tier 1]], 45 years old, leads the Loss Table. She is not a high-tier caster and has never claimed field hero status. Her authority comes from disciplined pattern work across hundreds of incident files.
...
The Loss Table sits at a structural fault line. [[The Council of Auralis]] wants visible expedition progress. Loss analysis often recommends slower cadence, narrower objective stacks, and higher staffing minimums.
...
The Zakros Loss Table is the part of expedition culture that remembers failure as a system, not anecdote.
