...
Projects a compact charge flow marker that remains stable long enough for routine tasks.
...
```json
{
  "name": "Electric Lantern Mark",
  "summary": "Creates a short-lived charge flow marker for close work.",
  "effect_description": "Projects a compact charge flow marker that remains stable long enough for routine tasks.",
  "hook": "Emit",
  "mode": "Create",
  "shape": "Triangle",
  "discipline": "Electric",
