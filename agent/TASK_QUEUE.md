...
- [x] **USER-013 — Story Bundle: Thirty Days After the First Casualty**
      **Source:** Continuation request (2026-03-07), follow-on modular war-sequence development
      **Goal:** Add a linked month-one aftermath story set showing financial restructuring, supply fragmentation, and institutional autonomy loss.
      **Scope:** 3 stories in `content/Stories/` + one index update in `content/The Three Near-Wars.md`.
      **Required outputs:** 3 story files + new bundle section in near-war hub.
...
- [ ] **USER-014 — Major Narrative Arc: War and Resolution (Multi-Phase)**
      ...
      **Status note:** IN PROGRESS — Phase 1 complete and Phase 2 active on 2026-03-07; assembly sequence established and ready for Phase 3 (Investigation + Escalation)
...
- [x] **Goal:** Build education pipelines from childhood to professional tracks.
      ...
      **Owner:** `Copilot Auto`
      **Status:** COMPLETE — Seven education notes created: Childhood Learning Networks (household/community early learning and seasonal interruption patterns), Tier Assessment and Placement Pathways (assessment-to-placement flow, appeals, and post-assessment drop-off), Guild Apprenticeship Tracks (entry filters, pay/dependency tradeoffs, completion failure modes), Ascendant Path Education Tracks (structured advancement, hidden compliance costs, attrition points), Specialist Training Routes (guides, scriveners, logistics routes and mentorship bottlenecks), Family Education Decision Pressure (household risk calculus, sibling strategy, class pressure), T0 and Non-Flux Work Entry Outcomes (majority work-entry lanes, constraints, and progression via specialization). Required updates complete: Control Tier.md (Education Trajectory Effects section) and Ordinary Life.md (Education Trajectory Summary section). Navigation refreshed: 707 nodes (+7 from 700), 7784 edges (+141 from 7643), 590 pages (+7 from 583). 2026-03-07.
...
- [x] **Goal:** Formalize seasonal calendar, climate pressure, and work cycles.
