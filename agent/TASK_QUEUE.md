...
- [x] **EXPANSION-014: Resource Extraction & Refinement**
      ...
      **Status:** COMPLETE - Ten comprehensive notes created: Extraction Industries (overview hub), Mining Operations (underground/surface extraction, labor, contemporary pressure), Logging Operations (seasonal cycles, forest management, labor conditions), Salt Extraction (coastal salt harvesting, supply to Hedun), Ruin Salvage Operations (pre-collapse artifact recovery, desert expeditions), Resource Processing (ore smelting, timber milling, creature-product refinement), three NPC profiles (Keln Moss T0 miner, Dorven Kess T3 logging supervisor, Sorven Tal T3 creature-product specialist), Resource Extraction Conflicts (institutional monopolization, environmental degradation, labor scarcity, specialist shortage, equipment failure dynamics). Economy.md updated with detailed extraction sector links and cross-references. Navigation artifacts refreshed (concept-graph: 651 nodes, 6682 edges, 550 pages; context-index: 550 pages)
